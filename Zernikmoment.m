...
disp(['radial polynomial ' num2str(Rad)]);
disp(['Moment ' num2str(Z)]);
disp(['No. of Pixels inside unit circle ' num2str(cnt)]);
% disp(['Normalize ' num2str(Z)]);
disp(['Amplitude ' num2str(A)]);
disp(['the phase value ' num2str(Phi)])